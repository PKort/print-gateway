...
Lekka aplikacja webowa do obsługi domowych drukarek przez CUPS. Obecna konfiguracja obsługuje znajdujące się w Gabinecie na dole: monochromatyczną HP LaserJet 4000 DTN przez JetDirect oraz kolorową HP Color LaserJet MFP M477fdn przez IPP Everywhere.

## Funkcje

- wysyłanie plików PDF do CUPS,
- wybór drukarki oraz trybu kolorowego lub czarno-białego,
...
- podgląd stanu zasilania obu drukarek,
- niezależne włączanie i wyłączanie ich gniazdek przez Home Assistant/MQTT,
...
3. Dostosuj `PRINTER_NAME`, `PRINTER_HOST`, `COLOR_PRINTER_HOST`, sieć Home Assistanta i mapowanie portów w `docker-compose.yml`.
4. Uruchom:
